 ...
 * - Dot: 24px diameter circle, accent color (same as primary button)
 ...
 * - Same font weight as active (semibold)
 *
 * Hover behavior:
 * - Service expands on hover
 *
 * Tokens used:
 * - Typography: --token-size-h3 (48px), --token-size-body-xs (14px)
 * - Spacing: --token-space-24
...
const ServiceItem = ({
  ...
  return (
    <div
      className="service-item w-full cursor-pointer"
      style={{
    ...
    >
      {active ? (
        ...
        >
          ...
          >
            {/* Dot indicator — 24x24px same as primary button */}
            <span
        ...
        >
          ...
          {/* Service Title — same style as active */}
          <h3
            className="service-title text-accent"
            style={{
              fontFamily: "var(--token-font-family-base)",
              fontSize: "var(--token-size-h3)", /* 48px */
              fontWeight: "var(--token-weight-semibold)", /* 600 - same as active */
              lineHeight: "var(--token-leading-110)", /* 1.1 */
              letterSpacing: "-1px",
              margin: 0,
            }}
